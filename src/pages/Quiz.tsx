...
const GameSession: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl flex flex-col items-center pt-8 relative">
      <button
        onClick={exitQuiz}
        className="fixed top-20 left-4 p-2 rounded-full bg-slate-800/80 backdrop-blur border border-slate-700 text-slate-400 hover:text-white hover:bg-red-500/20 hover:border-red-500/50 transition-all duration-200 z-50 group shadow-lg"
...
const QuizContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4 relative overflow-x-hidden">
