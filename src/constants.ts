...
export const QUESTIONS: Question[] = [
  {
    ...
    correctIndex: 1,
    explanation: "Marte é chamado de Planeta Vermelho devido ao óxido de ferro predominante em sua superfície, que lhe confere uma aparência avermelhada."
  },
  {
    id: 2,
    ...
    correctIndex: 1,
    explanation: "A fotossíntese é o processo utilizado por plantas para produzir seu próprio alimento usando luz solar, água e dióxido de carbono."
  },
  {
    id: 3,
    ...
    correctIndex: 2,
    explanation: "Leonardo da Vinci, um polímata do Renascimento, pintou a Mona Lisa no início do século XVI."
  }
];
